...
if(isset($_SESSION["id"]) && !empty($_SESSION["id"])){
	...
	if($lvlF){
		...
		if( isset($_COOKIE["levelSolved"]) && (strcmp($_COOKIE["levelSolved"],"[object Window]")==0) ){
			...
			if(updateScore($score,"1234")){  // updateScore(int newScore,String allClearedLevels)
...
<body>
<main>	
	<h3 style="text-align: right; color:magenta;"><?php echo $_SESSION["name"]." (".$_SESSION["roll"].")";?> &nbsp; &nbsp;L-4 &nbsp; Score: <?php echo $score; ?> &nbsp; &nbsp; <a href="leaderboard_table" target="_blank">Leaderboard</a> &nbsp; &nbsp; &nbsp;  <a href="logout.php">Log Out</a></h3>
	...
	<center id="main">
		<div>
			<iframe src="frame1.php" id="f1"></iframe>
		</div>
	</center>
</main>	
	<script>
	...
	var i = 0;
	var txt = 'Abhimanyu has now cleared the 3rd stage of the "Chakravyuh", and now is trying to beat the robo gaurd "Scriptor"  at the 4th door. Abhimanyu is stuck at this stage because he doesn\'t remember the XSS lesson from Hack-X-Ploit Workshop at Lucideus Ashram. Abhimanyu needs to use the mantras to fool him around and get inside the 4th door as well.';
	var speed = 0;
